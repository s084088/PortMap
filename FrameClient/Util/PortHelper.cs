...
namespace FrameClient.Util
{
    public static class PortHelper
    {
        ...
        /// <param name="ns"></param>
        /// <param name="s"></param>
        public static async Task H_Send(this NetworkStream ns, string s)
        {
        ...
        public static void Transfer(object obj)
        {
            ...
            {
                LogHelper.Logger("内网主动断开 " + ex.Message);
            }
        }
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        tc1.Dispose();
                        tc2.Dispose();
                        LogHelper.Logger("外网主动断开 " + ex.Message);
                        break;
                    }
                }
            }
